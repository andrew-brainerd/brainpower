...
function sendLogEmail($fn, $ln, $mk, $md, $ps, $r, $b)
{
    // the message
    ...
    $msg .= "Reason: " . $r . "<br>\n";
    $msg .= "Branch: " . $b . "<br>\n";
    $msg .= "<br><br><a href='https://umculobby.com/parking/?branch=$b&goto=view'>View Today's Check-Ins</a>";
...
function sendFacilitesEmail($fn, $ln, $ps, $as, $vd, $ra)
{
    ...
    $msg .= "</table>";
    $msg .= "<br><br><a href='https://umculobby.com/parking/index.php?branch=Huron&goto=view'>View Today's Check-Ins</a>";
    $msg .= "</body></html>";
